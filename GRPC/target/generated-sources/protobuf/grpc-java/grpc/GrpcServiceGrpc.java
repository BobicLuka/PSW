...
public final class GrpcServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.GrpcRequest,
      grpc.GrpcResponse> getGetDrugMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getDrug",
      requestType = grpc.GrpcRequest.class,
      responseType = grpc.GrpcResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.GrpcRequest,
      grpc.GrpcResponse> getGetDrugMethod() {
    io.grpc.MethodDescriptor<grpc.GrpcRequest, grpc.GrpcResponse> getGetDrugMethod;
      ...
      synchronized (GrpcServiceGrpc.class) {
        if ((getGetDrugMethod = GrpcServiceGrpc.getGetDrugMethod) == null) {
          GrpcServiceGrpc.getGetDrugMethod = getGetDrugMethod =
              io.grpc.MethodDescriptor.<grpc.GrpcRequest, grpc.GrpcResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getDrug"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.GrpcRequest.getDefaultInstance()))
  ...
  public static abstract class GrpcServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getDrug(grpc.GrpcRequest request,
        io.grpc.stub.StreamObserver<grpc.GrpcResponse> responseObserver) {
  ...
  public static final class GrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GrpcServiceBlockingStub> {
    ...
    /**
     */
    public grpc.GrpcResponse getDrug(grpc.GrpcRequest request) {
  ...
  public static final class GrpcServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.GrpcResponse> getDrug(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DRUG:
          serviceImpl.getDrug((grpc.GrpcRequest) request,
              (io.grpc.stub.StreamObserver<grpc.GrpcResponse>) responseObserver);
          break;
        default:
