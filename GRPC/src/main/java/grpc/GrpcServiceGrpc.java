...
public final class GrpcServiceGrpc {
  ...
  public static final String SERVICE_NAME = "grpc.GrpcService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<GrpcRequest,
      GrpcResponse> getGetDrugMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getDrug",
      requestType = GrpcRequest.class,
      responseType = GrpcResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<GrpcRequest,
      GrpcResponse> getGetDrugMethod() {
    io.grpc.MethodDescriptor<GrpcRequest, GrpcResponse> getGetDrugMethod;
    if ((getGetDrugMethod = GrpcServiceGrpc.getGetDrugMethod) == null) {
      synchronized (GrpcServiceGrpc.class) {
        if ((getGetDrugMethod = GrpcServiceGrpc.getGetDrugMethod) == null) {
          GrpcServiceGrpc.getGetDrugMethod = getGetDrugMethod =
              io.grpc.MethodDescriptor.<GrpcRequest, GrpcResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getDrug"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GrpcRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GrpcResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GrpcServiceMethodDescriptorSupplier("getDrug"))
              .build();
        }
      }
    }
    return getGetDrugMethod;
  }
  ...
  public static abstract class GrpcServiceImplBase implements io.grpc.BindableService {
    ...
    public void getDrug(GrpcRequest request,
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDrugMethod(), responseObserver);
    }
  ...
  public static final class GrpcServiceStub extends io.grpc.stub.AbstractAsyncStub<GrpcServiceStub> {
    ...
    public void getDrug(GrpcRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetDrugMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GrpcServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GrpcServiceBlockingStub> {
    ...
    /**
     */
    public GrpcResponse getDrug(GrpcRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetDrugMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class GrpcServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GrpcServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<GrpcResponse> getDrug(
        GrpcRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetDrugMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_DRUG = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DRUG:
          serviceImpl.getDrug((GrpcRequest) request,
              (io.grpc.stub.StreamObserver<GrpcResponse>) responseObserver);
          break;
        default:
